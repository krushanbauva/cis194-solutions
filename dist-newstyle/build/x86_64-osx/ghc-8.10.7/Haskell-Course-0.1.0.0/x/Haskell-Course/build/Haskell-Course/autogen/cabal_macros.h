...
/* package Haskell-Course-0.1.0.0 */
#ifndef VERSION_Haskell_Course
#define VERSION_Haskell_Course "0.1.0.0"
#endif /* VERSION_Haskell_Course */
#ifndef MIN_VERSION_Haskell_Course
#define MIN_VERSION_Haskell_Course(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_Course */
...
#define CURRENT_COMPONENT_ID "Haskell-Course-0.1.0.0-inplace-Haskell-Course"
